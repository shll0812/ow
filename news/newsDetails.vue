            ...
            <div class="news-left" v-cloak>
                ...
                <div class="news-over">
                    ...
                    <div class="enjoy" v-if="enjoy">
                        <span>分享到:</span>
                        <a href="javascript:;"><img src="img/news/main-news/news-share.png"></a>
                        <a href="javascript:;"><img src="img/news/main-news/news-share.png"></a>
                        <a href="javascript:;"><img src="img/news/main-news/news-share.png"></a>
                    </div>
                </div>
                ...
                <div class="content">
                    ...
                    <div class="content-list">
                        <div :class="{'content-now':!isself}" @click="toall">评论</div>
                        <div :class="{'content-now':isself}" @click="toself">只看自己</div>
                    </div>
                    <div class="content-all">
                        <div v-for="content in contents" :key="content.id">
                            <img src="img/news/main-news/content-name.png"/>
                            <div>
            ...
            if(!this.isself){
                ...
                this.axios.get(url).then(result=>{
                    ...
                    for(var i=0;i<this.contents.length;i++){
                        this.contents[i].content=this.contents[i].content.replace(/%2B/g, '+');
                        this.contents[i].content=this.contents[i].content.replace(/'%26/g, '&');
                        this.contents[i].content=this.contents[i].content.replace(/%23/g, '#');
                ...
                //var uid=this.uid;
                var uid=1;
                var url=`http://127.0.0.1:3000/getself?pno=${pno}&uid=${uid}`;
                this.axios.get(url).then(result=>{
                    this.contents=result.data.data;
                    this.count=parseInt(result.data.c[0]["COUNT(cid)"]);
                    this.page=Math.ceil(this.count/15);
