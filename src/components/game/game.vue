...
<div class="app-game">
    <section id="overview">
        <div class="intro">
            ...
            <div class="video">
                <a href="javascript:;">
                    <img src="img/yph/data/sc1/youtube-btn-ylw.png">
                </a>
            </div>
        </div>
    </section>
    ...
    <section id="modes">
        <div>
            <div>
                ...
                <div class="mode-item">
                    <div style="background-image:url('img/yph/data/sc8/thumb-practiceRange.jpg');">
                    ...
                    <div style="background-image:url('img/yph/data/sc8/thumb-vsAI.jpg');">
                        <div class="item-content">
                    ...
                    <div style="background-image:url('img/yph/data/sc8/thumb-quickPlay.jpg');">
                        <div class="item-content">
                    ...
                    <div style="background-image:url('img/yph/data/sc8/thumb-customGame.jpg');">
                        <div class="item-content">
                    ...
                    <div style="background-image:url('img/yph/data/sc8/thumb-arcade.jpg');">
                        <div class="item-content">
                    ...
                    <div style="background-image:url('img/yph/data/sc8/thumb-competitivePlay.jpg');">
                        <div class="item-content">
